...
class HTRTrainer(nn.Module):
    ...
    def prepare_dataloaders(self):
        ...
        subset_percentage = config.train.subset_perc  # for example, use 30% of data

        if (subset_percentage > 0.0 and subset_percentage < 1.0):
            print('Using {}% of training data -> total number of elements used: {}'.format(
                subset_percentage * 100, int(subset_percentage * len(train_set))))
            ...
            # Wrap the dataset with a Subset
